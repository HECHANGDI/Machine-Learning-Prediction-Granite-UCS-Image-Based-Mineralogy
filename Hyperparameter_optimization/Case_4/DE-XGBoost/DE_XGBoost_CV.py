...
- Optimizes XGBoost hyperparameters using DE (Differential Evolution)
...
# ------------------------------------------------------------
# 4. Objective function for DE
# ------------------------------------------------------------
def de_objective(param_vector):
    """
    Objective function for DE optimisation:
...
# ------------------------------------------------------------
# 5. Parameter bounds for the DE optimisation
# ------------------------------------------------------------
param_bounds = [
    (50, 500),      # n_estimators
    (3, 12),        # max_depth
...
# ------------------------------------------------------------
# 6. Run Differential Evolution (DE surrogate) optimisation
# ------------------------------------------------------------
print("\n===== Stage 2: Hyperparameter Optimisation DE =====")
...
print("\nOptimised Parameters (DE + top-15 SHAP features):")
...
# ------------------------------------------------------------
print("\n===== Repeated k-fold Cross-Validation with DE-XGBoost =====")
...
plt.tight_layout()
plt.savefig(
    "xgb_repeated_kfold_r2_distribution_DE_SHAP_top15.jpg", dpi=1000
)
plt.show()
...
# ------------------------------------------------------------
output_file = "model_metrics_output_DE_SHAP_top15_full.txt"
with open(output_file, "w") as f:
    f.write("Optimised Parameters (DE + top-15 SHAP features):\n")
...
plt.tight_layout()
plt.savefig("predicted_vs_actual_fit4_SHAP_top15_DE.jpg", dpi=1000, format="jpg")
plt.show()
